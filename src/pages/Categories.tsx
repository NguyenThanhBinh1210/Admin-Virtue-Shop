...
const Categories = () => {
  ...
  return (
    <div className='p-5'>
      <h1 className='mb-3  text-2xl font-bold dark:text-white'>Danh sách danh mục</h1>
      <div className='flex flex-col gap-[30px] rounded-md border-pink-400 dark:border-none border'>
